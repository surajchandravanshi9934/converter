...
export default function NavBar(){  
  ...
  const NavLink=({href,children})=>(<a href={href} className="relative text-indigo-950 dark:text-red/90 font-medium group">
    <span className="transition-colors group-hover:text-red">{children}</span>
